<?php
    $realSite = 'Wild About Weeds';
    $realSiteURL = 'http://www.wildaboutweeds.co.nz/';
    $designerName = 'Andy Ball';
...
function acknowledgement_script_custom(){
    ...
    <div id="acknowledgeOverlay" class="overlay">
        <div id="overlayContent">
            ...
            <hr>
            <p>This site was built for educational use only and is <strong>not</strong> the real site for <?= $GLOBALS['realSite']; ?>.</p>
            <p>This website was created at Yoobee School of Design by <?= $GLOBALS['designerName']; ?> and has no affiliation with <?= $GLOBALS['realSite']; ?>.</p>
            <a href="<?= $GLOBALS['realSiteURL']; ?>" target="blank">Click here to see the actual <?= $GLOBALS['realSite']; ?> website.</a><br>
